var SnailBait = function () {
    ...
    this.RUN_ANIMATION_RATE = 11,

    this.PLATFORM_HEIGHT = 0,
    this.PLATFORM_STROKE_WIDTH = 0,
    ...
    this.RUNNER_CELLS_WIDTH = 12; // pixels
    this.RUNNER_CELLS_HEIGHT = 16;

    this.BEE_CELLS_HEIGHT = 50;
    this.BEE_CELLS_WIDTH = 50;

    this.BUTTON_CELLS_HEIGHT = 32;
    this.BUTTON_CELLS_WIDTH = 32;
    ...
    this.blueButtonCells = [
       {
           left: 253, top: 528, width: this.BUTTON_CELLS_WIDTH,
           height: this.BUTTON_CELLS_HEIGHT
       },

       {
           left: 290, top: 528, width: this.BUTTON_CELLS_WIDTH,
           height: this.BUTTON_CELLS_HEIGHT
       },

       {
           left: 327, top: 528, width: this.BUTTON_CELLS_WIDTH,
           height: this.BUTTON_CELLS_HEIGHT
       }
    ];
    ...
    this.runnerCellsRight = [
       {
           left: 378, top: 544,
           width: 12, height: this.RUNNER_CELLS_HEIGHT
       },

       {
           left: 402, top: 545,
           width: 13, height: this.RUNNER_CELLS_HEIGHT
       },

       {
           left: 426, top: 544,
           width: 15, height: this.RUNNER_CELLS_HEIGHT
       },

       {
           left: 455, top: 544,
           width: 11, height: this.RUNNER_CELLS_HEIGHT
       },
    ],
    ...
    this.collideBehavior = {
        ...
        processCollision: function (sprite, otherSprite) {
            ...
            else if ('button' === otherSprite.type && !sprite.jumping) {
...
SnailBait.prototype = {
    ...
    drawBackground: function () {
        this.cavas = document.getElementById('snailbait-game-canvas');
        this.context = this.canvas.getContext('2d');
        var img = new Image();
          img.src = "bg.png";
    ...
    calculateFps: function (now) {
        ...
        if (now - this.lastButtonTime > 5000 - this.timing) {
            this.timing = this.timing + 750
            this.mush = this.mush + .1
            ...
            this.putSpriteOnPlatform(button,
             this.platforms[0]);
    ...
    turnRight: function () {
        ...
        //if (snailBait.runner.left + 5 < 1000) {
        snailBait.runner.left = snailBait.runner.left + 5;
        //}
    },
    ...
    revealInitialToast: function () {
        ...
        setTimeout(function () {
            snailBait.revealToast('Avoid the mushrooms.',
